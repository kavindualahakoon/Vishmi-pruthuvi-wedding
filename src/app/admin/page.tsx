...
import { Lock, Users, FileText, Download, Utensils, CalendarDays, Search, Edit2, Trash2, X, Save, Video, Type, CheckSquare, ZoomIn, Clock, Volume2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-light-bg flex flex-col md:flex-row">
      ...
      <div className="flex-1 p-4 md:p-8 overflow-y-auto relative">
        {activeTab === "guests" ? renderGuestList() : renderContentEditor()}
      </div>
